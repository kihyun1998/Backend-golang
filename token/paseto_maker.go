...
func NewPasetoMaker(symmetricKey string) (MakerForPaseto, error) {
...
func (maker *PasetoMaker) CreateToken(username string, duration time.Duration) (string, *PasetoPayload, error) {
